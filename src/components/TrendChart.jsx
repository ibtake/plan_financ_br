          ...
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={chartData} margin={{ top: 5, right: 5, left: 0, bottom: 0 }} onClick={(state) => {
              ...
              <XAxis
                ...
                tickLine={false}
              />
              <Tooltip active={Boolean(tooltipPosition)} content={<TooltipContent />} position={tooltipPosition || undefined} wrapperClassName={tooltipPosition ? `tooltip-${tooltipPosition.placement}` : ''} allowEscapeViewBox={{ x: true, y: true }} animationDuration={220} offset={0} cursor={false} />
              <Area
                type="monotone"
